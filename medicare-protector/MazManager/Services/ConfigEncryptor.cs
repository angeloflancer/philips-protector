...
{
    /// <summary>
    /// Handles encryption and storage of the protected executable configuration
    /// </summary>
    public class ConfigEncryptor
    {
        ...
        /// </summary>
        public List<ProtectedExecutable> LoadConfig(string serviceDirectory)
        {
            List<ProtectedExecutable> executables = new List<ProtectedExecutable>();

            try
            {
                string configPath = Path.Combine(serviceDirectory, CONFIG_FILE_NAME);
        ...
        /// </summary>
        public void SaveConfig(List<ProtectedExecutable> executables, string serviceDirectory)
        {
            try
            {
                string configPath = Path.Combine(serviceDirectory, CONFIG_FILE_NAME);
